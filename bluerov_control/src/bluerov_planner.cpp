...
#include "planner/bluerov_planner.h"
#include <unistd.h>

//register this planner as a BaseBluerovPlanner plugin
PLUGINLIB_EXPORT_CLASS(bluerov_planner::BluerovPlanner, nav_core::BaseGlobalPlanner)
 
	
namespace bluerov_planner {

	BluerovPlanner::BluerovPlanner (){}

	BluerovPlanner::BluerovPlanner(const std::string name, costmap_2d::Costmap2DROS* costmap_ros){
		initialize(name, costmap_ros);
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////
	// Initialize the Plugin
	void BluerovPlanner::initialize(std::string name, costmap_2d::Costmap2DROS* costmap_ros){

		// initialize subscriptions
		subPath = nh.subscribe("/global_path", 1, &BluerovPlanner::pathHandler, this);
		pubGoal = nh.advertise<geometry_msgs::PoseStamped>("/prm_goal", 2);
		// visualize twist command
		subTwistCommand = nh.subscribe<nav_msgs::Path>("/move_base/TrajectoryPlannerROS/local_plan", 1, &BluerovPlanner::twistCommandHandler, this);
	...
	// visualize twist command
	void BluerovPlanner::twistCommandHandler(const nav_msgs::Path::ConstPtr& pathMsg){
	...
	void BluerovPlanner::pathHandler(const nav_msgs::Path::ConstPtr& pathMsg){
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////
	bool BluerovPlanner::makePlan(const geometry_msgs::PoseStamped& start, const geometry_msgs::PoseStamped& goal,  std::vector<geometry_msgs::PoseStamped>& plan){
